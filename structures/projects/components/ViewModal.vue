...
const populateFields = () => {
  ...
  fields.value = [
    ...
    { label: 'Description', value: item.value.description },
    
    { label: 'StartDate', value: item.value.startDate },
    
    { label: 'EndDate', value: item.value.endDate },
    
    { label: 'Status', value: item.value.status },
    
    { label: 'Budget', value: item.value.budget },
    
    { label: 'ClientId', value: item.value.clientId },
